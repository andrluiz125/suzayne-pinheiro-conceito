      ...
      <main id="conteudo">
        ...
        <section className="hero" id="top">
          ...
          <div className="hero-content">
            ...
            <div className="hero-actions"><a className="button button-light" href="#diagnostico" style={{ textDecoration: "none" }}>Fazer meu diagnóstico <span>↗</span></a><a className="text-link" href="#contato">Prefiro falar direto <span>→</span></a></div>
        ...
        <section className="modalities-section" id="modalidades"><div className="section-shell"><div className="modalities-title reveal"><p className="section-index">06 — Formas de contratar</p><h2>Nenhuma modalidade é perfeita.<br /><em>Cada uma serve a um cenário.</em></h2></div>
          ...
          <a className="button button-dark center-button" href="#diagnostico" style={{ textDecoration: "none" }}>Descobrir o meu caso <span>↗</span></a></div>
        </section>
